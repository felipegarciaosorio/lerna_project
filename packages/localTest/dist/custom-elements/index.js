...
const IntCard$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
  ...
  static get style() { return intCardCss; }
};
...
const searchWorld = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
...
const IntSidenav = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  }
...
const IntCard = /*@__PURE__*/proxyCustomElement(IntCard$1, [1,"int-card",{"userName":[1025,"user-name"],"APIData":[32],"showAngularTab":[32],"showStencilTab":[32],"myStencilUsers":[32],"myAngularUsers":[32]},[[16,"searchWoldNameSelected","seasearchWoldNameSelectedHandler"]]]);
const IntNavbar = /*@__PURE__*/proxyCustomElement(IntNavbar$1, [1,"int-navbar",{"logoImage":[1,"logo-image"]}]);
const IntSearch = /*@__PURE__*/proxyCustomElement(searchWorld, [1,"int-search",{"searchText":[1025,"search-text"],"searchResult":[32],"userInput":[32]}]);
const IntSidebar = /*@__PURE__*/proxyCustomElement(IntSidenav, [4,"int-sidebar",null,[[0,"todoCompleted","todoCompletedHandler"]]]);
const IntSideitem = /*@__PURE__*/proxyCustomElement(IntSideItem, [4,"int-sideitem",{"name":[1]}]);
...
export { FontIcon, IntButton, IntCard, IntNavbar, IntSearch, IntSidebar, IntSideitem, defineCustomElements };
