/* IntelepeerWebComponent custom elements bundle */

import type { Components, JSX } from "../types/components";

interface FontIcon extends Components.FontIcon, HTMLElement {}
export const FontIcon: {
  prototype: FontIcon;
  new (): FontIcon;
};

interface IntButton extends Components.IntButton, HTMLElement {}
export const IntButton: {
  prototype: IntButton;
  new (): IntButton;
};
