...
const IntCard = class {
  ...
  render() {
    let angularContent = (index.h("div", null, index.h("div", { class: "card-custom", id: "angular-div" }, "Hello from angular", index.h("br", null), "Live Users ", index.h("span", null, this.myAngularUsers), index.h("button", { class: "btn-angular small-btn", onClick: this.fetchMyDataFromAPI.bind(this, 'angular') }, "Get Angular Users"), index.h("br", null))));
    let stencilContent = (index.h("div", null, index.h("div", { class: "card-custom", id: "stencil-div" }, "Hello from stencil", index.h("br", null), index.h("br", null), "Live Users ", index.h("span", null, this.myStencilUsers), index.h("button", { class: "btn-stencil small-btn", onClick: this.fetchMyDataFromAPI.bind(this, 'stencil') }, "Get Stencil Users"), index.h("br", null))));
    ...
    let mainContent = (index.h("div", null, index.h("div", { class: "int-card-wrapper" }, index.h("h1", null, "Hi ", this.userName), index.h("h5", null, this.APIData), index.h("button", { class: "btn-stencil small-btn", onClick: this.onContentChange.bind(this, 'stenciltab') }, "Get Stencil Users"), index.h("button", { class: "btn-angular small-btn", onClick: this.onContentChange.bind(this, 'angulartab') }, "Get Angular Users"), contentToDisplay, index.h("h", null), index.h("h3", null, "Two way data binding in stencil"), index.h("input", { type: "text", class: "my-input-textbox", onInput: this.onUserInput.bind(this), value: this.userName }), index.h("int-search", { "search-text": "bmw" }))));
    return mainContent;
  }
...
const searchWorld = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.searchWoldNameSelected = index.createEvent(this, "searchWoldNameSelected", 7);
    this.searchResult = [];
  }
  onUserInput(event) {
...
const IntSidenav = class {
  ...
  render() {
    return [
      index.h("div", { class: "sidebar" }, index.h("ul", { class: "sidebar-panel" }, index.h("side-item", { name: "testName", onClick: ev => this.todoCompletedHandler(ev) }, index.h("slot", null)))),
    ];
  }
};
...
const IntSideItem = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.selectData = index.createEvent(this, "selectData", 7);
    this.hoverItem = index.createEvent(this, "hoverItem", 7);
    this.numberOfClicks = index.createEvent(this, "numberOfClicks", 7);
  ...
  render() {
    return [
      index.h("li", { class: "side-item", value: this.name, onClick: (ev) => this.todoCompletedHandler(ev) }, index.h("slot", null))
    ];
  }
};
...
exports.int_card = IntCard;
exports.int_navbar = IntNavbar;
exports.int_search = searchWorld;
exports.int_sidebar = IntSidenav;
